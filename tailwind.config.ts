	...
	theme: {
		...
		extend: {
			colors: {
				...
				'space-pink': 'hsl(var(--space-pink))',
				'space-indigo': 'hsl(var(--space-indigo))',
			...
			animation: {
				...
				'gradient-sweep': 'gradient-sweep 1.5s ease-in-out forwards',
				'space-float': 'space-float 8s ease-in-out infinite',
				'space-drift': 'space-drift 12s ease-in-out infinite',
				'space-pulse': 'space-pulse 4s ease-in-out infinite',
