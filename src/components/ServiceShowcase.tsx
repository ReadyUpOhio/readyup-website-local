...
const ServiceShowcase = () => {
  return (
    <section id="services" className="py-16 lg:py-24 px-4">
      <div className="container mx-auto">
        <div className="text-center mb-10 lg:mb-14">
          <h2 className="text-4xl lg:text-6xl font-bold font-orbitron bg-gradient-to-r from-space-blue via-space-purple to-space-cyan bg-clip-text text-transparent">
            Our Services
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-10 max-w-5xl mx-auto">
          {/* Console Repairs */}
          <div className="glass-card rounded-3xl p-8 border border-white/10 hover:scale-[1.02] transition-all duration-300">
            <div className="flex items-center gap-4 mb-4">
              ...
              <div>
                <h3 className="text-2xl font-bold font-orbitron">Console Repairs</h3>
          ...
          <div className="glass-card rounded-3xl p-8 border border-white/10 hover:scale-[1.02] transition-all duration-300">
            <div className="flex items-center gap-4 mb-4">
              ...
              <div>
                <h3 className="text-2xl font-bold font-orbitron">Consulting for Buy/Sell/Trade Shops</h3>
